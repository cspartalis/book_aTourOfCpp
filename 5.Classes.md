...
- [Chapter 6](Essential%20Operations.md) presents constructors, destructors, and assignments. Also, the rules for using those to control the life cycle of objects and resource management.
